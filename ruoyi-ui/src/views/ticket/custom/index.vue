...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属分组" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属组" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择归属组" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
/*      upload: {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.userName + '"客户吗？').then(function() {
